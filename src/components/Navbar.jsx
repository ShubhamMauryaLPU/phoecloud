...
let navigation = [
  ...
  { name: "Our Services", to: "/services", current: false },
...
export default function Example() {
  ...
  return (
    <Disclosure
      as="nav"
      className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 dark:from-gray-800 dark:via-gray-900 dark:to-black"
    >
