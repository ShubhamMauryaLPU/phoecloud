...
const RevenueBoost = () => {
  return (
    <div className="py-12 bg-gray-950 flex flex-col justify-center items-center">
      <h1 className="text-2xl lg:text-4xl mt-4 text-center lg:w-[80%] dark:text-white font-bold font-serif">Elevate Your Revenue with PhoeTech's RBF Solutions</h1>
      <p className="text-base text-center px-7 w-[90%] lg:w-[80%] mt-3 dark:text-white font-bold font-serif">
          ...
          <div className="mt-4 flex justify-center h-[18rem]">
            <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
              <div className="p-4 sm:p-6 flex flex-col items-center flex-grow">
                <i class="fa-solid fa-rocket dark:text-white float-start text-6xl"></i>
                ...
                <Link to={"/"} className="text-black dark:text-white "><button className="hover:bg-gray-950 rounded-lg m-2 p-1">Discover RBF <i class="fa-solid fa-arrow-right-long"></i></button></Link>
              </div>
            </BackgroundGradient>
          </div>
          ...
          <div className="flex justify-center mt-4 h-[18rem]">
            <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
              <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                <i class="fa-solid fa-people-arrows dark:text-white float-start text-6xl"></i>
                ...
                <Link to={"/"} className="text-black dark:text-white "><button className="hover:bg-gray-950 rounded-lg m-2 p-1">EXPLORE SASS SOLUTIONS <i class="fa-solid fa-arrow-right-long"></i></button></Link>
              </div>
            </BackgroundGradient>
          </div>
        </div>
